...
export async function ensureSchema() {
  ...
  schemaPromise = (async () => {
    const statements = [
      ...
      `ALTER TABLE leads ALTER COLUMN parent_cpf DROP NOT NULL`,
      ...
      `ALTER TABLE leads ADD COLUMN IF NOT EXISTS birth_date text NULL`,
      `ALTER TABLE leads ADD COLUMN IF NOT EXISTS discount_percent integer NOT NULL DEFAULT 0`,
